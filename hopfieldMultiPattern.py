...
class hopfieldNet:
    ...
    #max odpowiada za maksymalną liczbę iteracji, data wiadomo
        for i in range(max):
            ...
            #jeżeli dane są identyczne jak wzorzece albo przeciwności wzorca to kończymy działanie
...
print("\nTest1")
result1 = network.test(testData1, 50) #poprawnie odtworzony wzorzec
print("\nTest2")
result2 = network.test(testData2, 50) #poprawnie odtworzony wzorzec
print("\nTest3")
result3 = network.test(testData3, 50) #poprawnie odtworzony wzorzec
